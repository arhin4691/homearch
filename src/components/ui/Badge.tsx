...
const categoryColors: Record<string, string> = {
  ...
  Household: "bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-300",
  Clothing: "bg-pink-100 text-pink-700 dark:bg-pink-900/30 dark:text-pink-300",
  Beauty: "bg-fuchsia-100 text-fuchsia-700 dark:bg-fuchsia-900/30 dark:text-fuchsia-300",
  Documents: "bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-300",
